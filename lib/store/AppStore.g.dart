...
mixin _$AppStore on _AppStore, Store {
  ...
  final _$currencyStoreModelAtom = Atom(name: '_AppStore.currencyStoreModel');

  @override
  CurrencyStoreModel get currencyStoreModel {
    _$currencyStoreModelAtom.reportRead();
    return super.currencyStoreModel;
  }

  @override
  set currencyStoreModel(CurrencyStoreModel value) {
    _$currencyStoreModelAtom.reportWrite(value, super.currencyStoreModel, () {
      super.currencyStoreModel = value;
    });
  }
  ...
  void setCurrencyStoreModel() {
    final _$actionInfo = _$_AppStoreActionController.startAction(
        name: '_AppStore.setCurrencyStoreModel');
    try {
      return super.setCurrencyStoreModel();
    } finally {
